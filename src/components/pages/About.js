  ...
  return (
    <section id="about">
      ...
      <p>
        ...
        as a Head Chef in high-pressure and fine dining kitchens across London.
        With my combined love of problem solving and bringing complicated ideas
        to life, I'm now in the brilliant world of web development.
      </p>
      <br></br>
      <p>
